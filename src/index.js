...
VanillaPinchZoom.prototype = {
    ...
    updateAspectRatio: function () {
        ...
        if(aspectRatio > 1) {
            this.setContainerY(this.el.offsetWidth / this.getAspectRatio());
        }
        else {
            this.setContainerX(this.el.offsetHeight / this.getAspectRatio());
        }
    },
    ...
    getInitialZoomFactor: function () {
        ...
        // the same as .height()
        return 1;//this.container.offsetWidth / this.el.offsetWidth;
    },
